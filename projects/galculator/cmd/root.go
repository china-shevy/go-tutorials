...
var rootCmd = &cobra.Command{
	Use:   "gal",
	Short: "Galculator is a calculator written in Go.",
	Long:  `Galculator is a calculator written in Go. It is an interactive command line calculator designed for educational purpose.`,
